---
name: interview
description: Interview the user relentlessly about a plan or design until reaching shared understanding, resolving each branch of the decision tree. If the project keeps domain docs (CONTEXT.md, docs/adr/), challenges the plan against them and updates them inline as decisions crystallise. Use when user wants to stress-test a plan, get grilled on their design, or mentions "interview" or "grill me".
---
